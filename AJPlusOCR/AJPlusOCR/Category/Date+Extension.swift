...
extension Date {
    ...
    //----------------------
    //字符串 年-月-日 时-分-秒 转  时：分
    static func strConverYearMonthDayStr(dateStr: String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone(identifier: "UTC")
    ...
    //-------------------------------
    //字符串 年-月-日 时-分-秒 转 年-月-日
    static func strConverYearMonthDayHourToYearMonthDayStr(dateStr: String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone(identifier: "UTC")
        dateFormatter.dateFormat = "YYYY-MM-dd HH:mm:ss"
        guard let datef = dateFormatter.date(from: dateStr) else {
        ...
        let hourMinutesStr = Date.strConverToYearMonthDay(date: datef)
        return hourMinutesStr
    }
    // date 转 年-月-日
    static func strConverToYearMonthDay(date: Date) -> String {
        let formatter = DateFormatter()
        formatter.timeZone = TimeZone(identifier: "UTC")
